...
class BridgeAttendedTransfer extends Event
{
    ...
    public function __construct($jsonResponse)
    {
        ...
        $this->destinationLinkFirstLeg = property_exists($this->response, 'destination_link_first_leg') ? $this->response->destination_link_first_leg : null;
        $this->destinationLinkSecondLeg = property_exists($this->response, 'destination_link_second_leg') ? $this->response->destination_link_second_leg : null;
        $this->destinationThreewayBridge = property_exists($this->response, 'destination_threeway_bridge') ? $this->response->destination_threeway_bridge : null;
        $this->destinationThreewayChannel = property_exists($this->response, 'destination_threeway_channel') ? $this->response->destination_threeway_channel : null;
        ...
        $this->transferTarget = property_exists($this->response, 'transfer_target') ? $this->response->transfer_target : null;
        $this->transferee = property_exists($this->response, 'transferee') ? $this->response->transferee : null;
        $this->transfererFirstLeg = $this->response->transferer_first_leg;
        $this->transfererFirstLegBridge = property_exists($this->response, 'transferer_first_leg_bridge') ? $this->response->transferer_first_leg_bridge : null;
        $this->transfererSecondLeg = $this->response->transferer_second_leg;
        $this->transfererSecondLegBridge = property_exists($this->response, 'transferer_second_leg_bridge') ? $this->response->transferer_second_leg_bridge : null;
    }
