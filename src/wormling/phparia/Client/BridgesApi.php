...
class BridgesApi extends Base
{
     ...
     * @return Bridge[]
     */
    public function getBridges($only = null)
    {
        $uri = '/bridges';
     ...
     * @throws ConflictException
     */
    public function playMedia($bridgeId, $media, $lang, $offsetms, $skipms, $playbackId)
    {
     ...
     * @throws ConflictException
     */
    public function playMediaById($bridgeId, $media, $lang, $offsetms, $skipms, $playbackId)
    {
     ...
     * @throws UnprocessableEntityException
     */
    public function record($bridgeId, $name, $format, $maxDurationSeconds, $maxSilenceSeconds, $ifExists, $beep, $terminateOn)
    {
